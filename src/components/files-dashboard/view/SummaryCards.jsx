  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="w-full bg-white h-[150px] flex flex-col opacity-100 gap-4 rounded-[8px] p-4 border border-solid">
        <h1 className="text-[#676767] font-normal text-base leading-[100%] tracking-[0%]">
          {title}
        </h1>
        <p className="font-poppins font-bold text-[36px] leading-[100%] tracking-[0%]">
          {value}
        </p>
        <div className="flex items-center gap-1">
          ...
          <p
            className={`font-poppins text-base leading-[100%] tracking-[0%] text-[16px] ${
              isPositive ? "text-[#0ADA6A]" : "text-[#FF1F58]"
            }`}
          >
            {change}
            <span className="text-[#676767] font-normal text-[12px] md:text-[14px] lg:text-[16px] xl:text-[18px]">
              {" "}
              since last month
            </span>
          </p>
